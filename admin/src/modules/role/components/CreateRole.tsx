...
const CreateRole = () => {
      ...
      if (allChildPermissionsSelected) {
        setSelectedPermissions(
          selectedPermissions.filter(
            (p) =>
              !(
                nonMasterResources.includes(p.resourceType as any) &&
  ...
  const selectAllForResource = (resource: string) => {
    ...
    const allSelected = childActions.every((action) =>
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Thêm quyền mới</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`mt-1 block w-full rounded-lg border px-4 py-2 focus:outline-none ${
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setFormData({ ...formData, description: e.target.value.slice(0, 255) })
                }
                maxLength={255}
                rows={3}
                ...
                {resources.map((resource) => (
                  <tr key={resource} className="hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-center">
                      <input
                        type="checkbox"
                        checked={childActions.every((action) =>
                          hasPermission(resource, action),
                        )}
        ...
        <div className="flex justify-end gap-4">
          ...
          >
            {loading ? "Đang tạo..." : "Thêm quyền mới"}
          </button>
        </div>
      </form>
    </div>
