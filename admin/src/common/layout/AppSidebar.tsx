...
const navItems: MenuItem[] = [
  ...
  },
  {
    ...
    requiredPermission: {
      resource: PermissionResource.SERVICE_CATEGORY,
      action: PermissionAction.GET,
    },
  },
  {
  ...
  },
  {
    ...
    path: "/leads",
    requiredPermission: {
      resource: PermissionResource.LEAD,
      action: PermissionAction.GET,
    },
  },
  {
  ...
  },
  {
    ...
    path: "/trainers",
    requiredPermission: {
      resource: PermissionResource.TRAINER,
      action: PermissionAction.GET,
    },
  },
  {
    icon: <DocsIcon />,
    name: "Ý kiến hội viên (Feedback)",
    path: "/feedbacks",
    requiredPermission: {
